...
class PathwayConfig(PretrainedConfig):
    r"""
    ...
    def __init__(
        ...
        num_experts=6,
        topk_experts=2,
        encoder_moe_layers=12,
        decoder_moe_layers=12,
        **kwargs
    ):
        super().__init__(
        ...
        self.encoder_moe_layers = encoder_moe_layers
        self.decoder_moe_layers = decoder_moe_layers
